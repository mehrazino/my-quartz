        ...
        <div style={{ textAlign: 'center' }}>
          <ul style={{ display: 'inline-flex', gap: '1rem', justifyContent: 'center', padding: 0 }}>
            <li style={{ listStyle: 'none' }}>
              <a href="https://github.com/mehrazino" class="github-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ verticalAlign: 'middle', marginLeft: '0.5rem' }}>
            ...
            <li style={{ listStyle: 'none' }}>
              <a href="https://telegram.me/Mehraz_Logs" class="telegram-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ verticalAlign: 'middle', marginLeft: '0.5rem' }}>
